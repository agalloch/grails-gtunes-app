    ...
    <body>
        ...
        <div id="show-album" class="content scaffold-show" role="main">
            ...
            <ol class="property-list album">
                ...
                <g:if test="${albumInstance?.yearReleased}">
                <li class="fieldcontain">
                    <span id="yearReleased-label" class="property-label"><g:message code="album.yearReleased.label" default="Year Released" /></span>

                        <span class="property-value" aria-labelledby="yearReleased-label"><g:formatDate date="${albumInstance?.yearReleased}" /></span>
