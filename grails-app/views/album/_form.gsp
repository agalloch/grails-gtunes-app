...
<div class="fieldcontain ${hasErrors(bean: albumInstance, field: 'yearReleased', 'error')} required">
    <label for="yearReleased">
        <g:message code="album.yearReleased.label" default="Year Released" />
        <span class="required-indicator">*</span>
    </label>
    <g:datePicker name="yearReleased" precision="day"  value="${albumInstance?.yearReleased}"  />
</div>
