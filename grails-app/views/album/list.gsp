            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <g:sortableColumn property="yearReleased" title="${message(code: 'album.yearReleased.label', default: 'Year Released')}" />
                ...
                <g:each in="${albumInstanceList}" status="i" var="albumInstance">
                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                        ...
                        <td><g:formatDate date="${albumInstance.yearReleased}" /></td>
